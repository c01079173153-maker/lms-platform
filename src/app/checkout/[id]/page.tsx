...
const courses = {
  'course-ai-101': {
    title: '시니어 AI 101 - 챗GPT, 클로드, 제미나이 완벽 활용법',
    price: 199000,
    desc: '세상에서 가장 똑똑한 3대 AI(챗GPT, 클로드, 제미나이)를 내 비서처럼 부리는 방법. 일상 대화부터 번역, 문서 요약, 기획까지 쉽고 완벽하게 알려드립니다.',
    image: '/course-ai.png',
    curriculum: [
      '1강: 챗GPT 가입부터 기본 대화법 마스터하기',
      '2강: 긴 글 요약의 달인, 클로드(Claude) 활용법',
